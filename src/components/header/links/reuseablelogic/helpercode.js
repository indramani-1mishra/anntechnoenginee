export const menuData = [
  {
    ...
    items: [
      { name: "Portable Room De humidifier", path: "" },
      { name: "Compact Dehumidifier ateD500 50 L/Day", path: "" },
      { name: "De humidifier 90 L/Day", path: "" },
      { name: "Compact Dehumidifier 60 L Day ateD600", path: "" },
  ...
  },
   {
    ...
    items: [
      ...
      { name: "Portable Dehumidifiers SS 304 ateD600SS", path: "" },
      { name: "Storage Room Dehumidifier", path: "" },
      { name: "Industrial Refrigerant Dehumidifier ateD800 80 L/D", path: "" },
      { name: "Industrial Refrigerator Dehumidifier 150 L/Day", path: "" }
    ]
  },
   {
    ...
    items: [
      ...
      { name: "Desiccant Dehumidifier 1000CMH", path: "" },
      { name: "Industrial Desiccant Dehumidifier 1500cmh", path: "" }
    ]
  },
  {
